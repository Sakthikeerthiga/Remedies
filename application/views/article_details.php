...
<?php if(!empty($article_details)){ ?>
  <section class="section pt-0">
    <div class="container">
      ...
      <?php echo strtoupper($article_details[0]['seo_title']); ?>
    </h2>
...
<div class="col-lg-8 article-details">
  <img class="rounded my-3" src="<?php echo base_url().'assets/uploads/article/'.$article_details[0]['thumbnailImage'] ?>" alt="<?php echo $article_details[0]['imageAltText'] ?>">
...
//if the string doesn't contain any space then it will cut without word basis.
      ...
      <p>
       <b class="text-secondary article_part">Article Details  &nbsp;&nbsp;</b> :'<?php echo $article_details[0]['articlepart']; ?>
      </p>
    </article>
