...
title:{
  text: "Remedies for this article",
  fontColor: "#66B93A",
  fontFamily: "tahoma",
  fontSize: 30
},
...
<div class="container">
  <nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item" ><a href="<?php echo base_url();?>remedies-list">Remedies</a></li>
    ...
    <div class="row">
      ...
      <div class="col-12">
        <h2 class="text-uppercase space-mb-4">
          <?php echo strtoupper($remedy_name); ?>
        </h2>
...
<?php if(!empty($remedy_chart) || !empty($relief_chart) ){ ?>
  ...
  <div id="chartContainer1" style="height: 370px; width: 100%;"></div>
    ...
    <p class="font-italic mt-4 mb-5">
      <a href="<?php if($slug !=''){ ?><?php echo base_url();?>remedy-testimony/<?php echo  $slug?><?php } ?>">
        <u>
      ...
      <div class="space-5 mb-0">
        ...
        <ul class="list-unstyled text-secondary link-list-blurb">
          <?php  foreach($get_related_article as $article){ ?>
            <li> <a href="<?php echo base_url().'remedy-articles/'.$article['articleUrl'].'/'.$remedy_name ?>"><?php echo $article['seo_title']; ?> </a></li>
          <?php } ?>
        </ul>
      </div>
    <?php } ?>
